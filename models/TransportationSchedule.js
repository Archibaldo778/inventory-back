...
const transportationRouteSchema = new mongoose.Schema({
  ...
  taskSource: { type: String, enum: ['event', 'side'], default: 'event' },
  ...
  reviewStatus: { type: String, enum: ['pending', 'confirmed'], default: 'pending' },
  reviewedAt: { type: Date, default: null },
  reviewedWarningKey: { type: String, default: '', trim: true },
  sourceEventStart: { type: String, default: '', trim: true },
  sourceEventEnd: { type: String, default: '', trim: true },
  sourceAddress: { type: String, default: '', trim: true },
  sourceStaffFingerprint: { type: String, default: '', trim: true },
