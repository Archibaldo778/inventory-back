...
export const DEFAULT_COCKTAIL_RECIPES = [
  recipe('agave-spice', 'Agave Spice', [['Tequila', 50], ['Lime', 25], ['Simple Syrup', 20], ['Cucumber', 15], ['Jalapeño Tincture', null, 'To taste']], [], 'Shake well with ice.\nStrain over fresh ice into a Rocks glass.\nGarnish with a Cucumber Slice.'),
  recipe('arm-in-arm', 'Arm in Arm', [['Vodka', 50], ['Lime', 25], ['Simple Syrup', 20], ['Grapefruit', 20], ['St-Germain', 15], ['Peychaud’s Bitters', 0.5]], [], 'Shake well with ice.\nStrain into a coupe or Nick and Nora glass.\nGarnish with a Grapefruit Twist.'),
  ...
  recipe('bonfire-nights', 'Bonfire Nights', [['Tequila', 40], ['Mezcal', 10], ['Lime', 22], ['Grapefruit', 22], ['Simple Syrup', 18]], [], 'Shake well with ice.\nStrain over fresh ice into a Rocks glass.\nGarnish with a Grapefruit Twist.'),
  ...
  recipe('early-sunset', 'Early Sunset', [['Vodka', 40], ['Lime', 25], ['Simple Syrup', 25], ['Yuzu', 5], ['Mint', null, 'Squeeze and strain'], ['Hibiscus Float', null, 'Pour over']], [], 'Shake well with ice.\nDouble strain over fresh ice into a Rocks glass.\nPour Hibiscus Float over the cocktail.\nGarnish with a Mint Sprig.'),
